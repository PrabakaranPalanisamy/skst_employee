...
public class MonthlyCollectionActivity extends AppCompatActivity {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2,
                ...
                if (text.equals("") || text.equals(null)) {
                    ...
                    if (customer_listmain.size() > 0) {
                        ...
                        adapterlist = new CustomAdaptercustomer(MonthlyCollectionActivity.this, customer_listmain);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (enroll_list_local.size() > 0) {
                        ...
                        try {
                            hidePDialog();
                            Toast.makeText(MonthlyCollectionActivity.this, "database loaded", Toast.LENGTH_SHORT).show();
                        ...
                        AlertDialog.Builder alertDialog = new AlertDialog.Builder(
                                MonthlyCollectionActivity.this);
    ...
    public void reterivelocal() {
        ...
        customer_list.clear();
        customer_listmain.clear();
        customer_list = dbcust.getAllMonthlyContacts();
        customer_listmain.addAll(customer_list);
    ...
    public void reterivelocalmycust() {
        ...
        customer_list.clear();
        customer_listmain.clear();
        customer_list = dbcust.getAllMONTHLYmycontacts(pref.getString("userid",""));
        customer_listmain.addAll(customer_list);
    ...
    public void reterivelocalmycustoutstandings() {
        ...
        customer_list.clear();
        customer_listmain.clear();
        customer_list = dbcust.getMONTHLYmycontactswithoutsatndings(pref.getString("userid",""));
        customer_listmain.addAll(customer_list);
    ...
    public void reterivelocalothercustoutstandings() {
        ...
        customer_list.clear();
        customer_listmain.clear();
        customer_list = dbcust.getMONTHLYallcontactswithoutsatndings(pref.getString("userid",""));
        customer_listmain.addAll(customer_list);
    ...
    public void listclick(final String cusid, final String cusname) {
        ...
        final Dialog dialog = new Dialog(MonthlyCollectionActivity.this);
        ...
        adapter1 = new Listadapterfeedback(MonthlyCollectionActivity.this, feedlistmain);
        ...
        btn_recepit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog.dismiss();
                Intent irt = new Intent(MonthlyCollectionActivity.this, RecepitActivity.class);
                irt.putExtra("cusid", cusid);
                irt.putExtra("cusname", cusname);
                irt.putExtra("type","Monthly");
                startActivity(irt);
                finish();
            }
        });
        ...
        next_followup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog fromDatePickerDialog = new DatePickerDialog(MonthlyCollectionActivity.this, new DatePickerDialog.OnDateSetListener() {
        ...
        StringRequest movieReq = new StringRequest(Request.Method.POST,
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (Success.equals("0")) {
                        hidePDialog();
                        Toast.makeText(MonthlyCollectionActivity.this, Details, Toast.LENGTH_LONG).show();
                        //  listclick(cusid);
                    } else {
