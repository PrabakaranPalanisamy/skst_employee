...
/**
 * Created by admin1 on 7/19/2017.
 */
...
//    static String loginurl = "http://mazenettech.net/SKST_CHIT_FUNDS/Mobile/";
   ...
   // public static String saveloanreceipt = loginurl + "recepit_amount_others.php?";
    public static String saveloanreceipt = loginurl + "recepit_amount_otherspics.php?";
    public static String retrievebranch = loginurl + "branchmaster.php?";
    ...
    public static String reterivereceipts = loginurl + "viewprevtransacs.php?";
   ...
   // public static String saverecepit = loginurl + "saverecepit.php?";
    public static String saverecepit = loginurl + "saverecepitpics.php?";
    public static String retrievealluser = loginurl + "reteriveallusers.php?";
    public static String geteditsettle = loginurl + "geteditsettle.php?";
    public static String updatesettle = loginurl + "updatesettlement.php?";
