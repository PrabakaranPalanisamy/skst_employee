...
public class WeeklyCollectionActivity extends AppCompatActivity {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (enroll_list_local.size() > 0) {
                        ...
                        try {
                            hidePDialog();
                            Toast.makeText(WeeklyCollectionActivity.this, "database loaded", Toast.LENGTH_SHORT).show();
    ...
    public void reterivelocal() {
        ...
        customer_list.clear();
        customer_listmain.clear();
        customer_list = dbcust.getAllWeeklyContacts();
        customer_listmain.addAll(customer_list);
    ...
    public void listclick(final String cusid, final String cusname) {
        ...
        final Dialog dialog = new Dialog(WeeklyCollectionActivity.this);
        ...
        adapter1 = new Listadapterfeedback(WeeklyCollectionActivity.this, feedlistmain);
        ...
        next_followup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog fromDatePickerDialog = new DatePickerDialog(WeeklyCollectionActivity.this, new DatePickerDialog.OnDateSetListener() {
        ...
        StringRequest movieReq = new StringRequest(Request.Method.POST,
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (Success.equals("0")) {
                        hidePDialog();
                        Toast.makeText(WeeklyCollectionActivity.this, Details, Toast.LENGTH_LONG).show();
                        //  listclick(cusid);
                    } else {
