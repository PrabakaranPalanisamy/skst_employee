...
public class PrintActivityLoans extends AppCompatActivity {
    // Debugging
    ...
    public PrintActivityLoans() throws ParseException {
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            paymode = it.getStringExtra("paytype");
            pendingamnt = it.getStringExtra("pending");
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    OnClickListener mBtnConnetBluetoothDeviceOnClickListener = new OnClickListener() {
        ...
        public void onClick(View arg0) {
            ...
            serverIntent = new Intent(PrintActivityLoans.this, DeviceListActivity.class);
            ...
            if (amntlen <= 32) {
                ...
                for (int j = 0; j < dumlength; j++) {
                    Amount = " "+Amount ;
                        ...
                        //   BluetoothPrintDriver.LF();
                        try {
                            Double d = Double.parseDouble(pendingamnt);
            ...
            if (amntlen <= 32) {
                ...
                for (int j = 0; j < dumlength; j++) {
                    paymode = " "+paymode ;
                        ...
                        Intent i=new Intent(PrintActivityLoans.this,CollectionActivity.class);
                        startActivity(i);
                        finish();
                    }
                }, 1500);
