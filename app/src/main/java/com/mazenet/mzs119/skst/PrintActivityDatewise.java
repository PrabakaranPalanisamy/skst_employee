...
public class PrintActivityDatewise extends AppCompatActivity {
    // Debugging
    ...
    String[] item_array;
    String Cusname = "", Amount = "", Groupname = "", ticketno = "", paymode = "", Receiptno = "", pendingamnt = "", penaltyamnt = "", instlmntamnt = "", bonusamnt = "", username = "", advanceamnt = "", Receivedamnt = "",Pendingamnt="",Advanceamntt="";
    ...
    public PrintActivityDatewise() throws ParseException {
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            pendingamnt = it.getStringExtra("pendingamnt");
            penaltyamnt = it.getStringExtra("penaltyamnt");
            instlmntamnt = it.getStringExtra("instlmntamnt");
            bonusamnt = it.getStringExtra("bonusamnt");
            advanceamnt = it.getStringExtra("advance");
    ...
    OnClickListener mBtnConnetBluetoothDeviceOnClickListener = new OnClickListener() {
        ...
        public void onClick(View arg0) {
            ...
            serverIntent = new Intent(PrintActivityDatewise.this, DeviceListActivity.class);
            ...
            if (amntlen <= 32) {
                ...
                for (int j = 0; j < dumlength; j++) {
                    paymode = " "+paymode ;
                        ...
                        BluetoothPrintDriver.BT_Write(advanceamnt + " Rs" + "\n");
                        // BluetoothPrintDriver.LF();
